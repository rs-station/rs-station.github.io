      ...
      <div class="row justify-content-center">
        <div class="col-lg-7 col-md-9 text-center">
          ...
          <p class="vision-text reveal" style="transition-delay:.2s">
            RSS is an organization building an open-source ecosystem for frontier structural biology, spanning X-ray crystallography, cryo-EM/ET, SAXS, and the AI that increasingly connects structure to function.
